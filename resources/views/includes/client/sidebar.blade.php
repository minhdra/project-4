            ...
            <form class="">
                ...
                <div class="p-4 p-md-6">
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signinEmailLabel9" class="form-label" for="signinEmail9">Tên tài khoản *</label>
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signinPasswordLabel9" class="form-label" for="signinPassword9">Mật khẩu *</label>
                  ...
                  <div class="d-flex justify-content-between mb-5 align-items-center">
                    ...
                    <a class="js-animation-link text-dark font-size-2 t-d-u link-muted font-weight-medium" href="javascript:;" data-target="#forgotPassword1" data-link-group="idForm1" data-animation-in="fadeIn">Quên mật khẩu?</a>
                  </div>
                  <div class="mb-4d75">
                    <button type="submit" class="btn btn-block py-3 rounded-0 btn-dark">Đăng nhập</button>
                  </div>
                  <div class="mb-2">
                    <a href="javascript:;" class="js-animation-link btn btn-block py-3 rounded-0 btn-outline-dark font-weight-medium" data-target="#signup1" data-link-group="idForm1" data-animation-in="fadeIn">Tạo tài khoản</a>
                  </div>
                </div>
              </div>
              ...
              <div id="signup1" style="display: none; opacity: 0;" data-target-group="idForm1">
                ...
                <div class="p-4 p-md-6">
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signinEmailLabel11" class="form-label" for="signinEmail11">Tài khoản *</label>
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signinPasswordLabel11" class="form-label" for="signinPassword11">Mật khẩu *</label>
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signupConfirmPasswordLabel9" class="form-label" for="signupConfirmPassword9">Xác nhận mật khẩu *</label>
                  ...
                  <div class="text-center mb-4">
                    ...
                    <a class="js-animation-link small" href="javascript:;" data-target="#login1" data-link-group="idForm1" data-animation-in="fadeIn">Đăng nhập
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div id="forgotPassword1" style="display: none; opacity: 0;" data-target-group="idForm1">
                ...
                <div class="p-4 p-md-6">
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signinEmailLabel33" class="form-label" for="signinEmail33">Tài khoản *</label>
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-block py-3 rounded-0 btn-dark">Xác nhận</button>
                  </div>
                  <div class="text-center mb-4">
                    <span class="small text-muted">Bạn nhớ tài khoản của mình?</span>
                    <a class="js-animation-link small" href="javascript:;" data-target="#login1" data-link-group="idForm1" data-animation-in="fadeIn">Đăng nhập
                    </a>
                  </div>
                </div>
            ...
            <di class="">
                ...
                <div class="p-4 p-md-6">
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      ...
                      <input type="text" class="form-control rounded-0 height-4 px-4" name="username" id="username" placeholder="Tài khoản" ng-model="loginModel.username" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      ...
                      <input type="password" class="form-control rounded-0 height-4 px-4" name="password" id="signinPassword" placeholder="Mật khẩu" ng-model="loginModel.password" required>
                    </div>
                  </div>
                  ...
                  <div class="mb-4d75">
                    <button class="btn btn-block py-3 rounded-0 btn-dark" ng-click="login()">Đăng nhập</button>
                  </div>
                  <div class="mb-2">
              ...
              <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                ...
                <div class="p-4 p-md-6">
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signUpUsernameLabel" class="form-label" for="signUpUsername">Tên tài khoản *</label>
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signinPasswordLabel1" class="form-label" for="signupPassword">Mật khẩu *</label>
                  ...
                  <div class="form-group mb-4">
                    <div class="js-form-message js-focus-state">
                      <label id="signupConfirmPasswordLabel" class="form-label" for="signupConfirmPassword">Xác nhận mật khẩu *</label>
                      ...
                      <span class="text-danger mb-10">@{{registerModel.password===registerModel.confirmPassword?'':'Mật khẩu phải giống nhau'}}</span>
                    </div>
                  </div>

                  <div class="mb-3">
                    <button class="btn btn-block py-3 rounded-0 btn-dark" ng-click="register()" ng-disabled="registerModel.password!==registerModel.confirmPassword">Tạo tài khoản</button>
                  </div>
                  <div class="text-center mb-4">
                    <span class="small text-muted">Bạn đã có tài khoản?</span>
              ...
              <div id="forgotPassword" style="display: none; opacity: 0;" data-target-group="idForm">
                ...
                <div class="p-4 p-md-6">
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-block py-3 rounded-0 btn-dark">Khôi phục</button>
                  </div>
                  <div class="text-center mb-4">
                    <span class="small text-muted">Bạn nhớ tài khoản?</span>
                    <a class="js-animation-link small" href="javascript:;" data-target="#login" data-link-group="idForm" data-animation-in="fadeIn">Đăng nhập
                    </a>
                  </div>
                </div>
...
<!-- Cart -->
<aside id="sidebarContent1" class="u-sidebar u-sidebar__xl" aria-labelledby="sidebarNavToggler1" ng-controller="headerController">
        ...
        <div class="u-sidebar__body">
          ...
          <div class="u-sidebar__content u-header-sidebar__content" ng-if="customer.id && customer.cart_details.length == 0">
            ...
            <div class="px-4 mb-8 px-md-6">
              <h3 class="font-size-5 py-4 mb-0 text-center">
                Bạn không có giỏ hàng nào
              </h3>
              <img class="my-4" src="/assets/img/others/no-cart.png" alt="" width="100%">
              <a href="/shop/list" class="btn btn-block btn-primary py-4 rounded-0  mb-4">Tiếp tục mua sắm</a>
            </div>
          </div>
          <div class="u-sidebar__content u-header-sidebar__content" ng-if="!customer.id">
            ...
            <div class="px-4 mb-8 px-md-6">
              ...
              <img class="my-4" src="/assets/img/others/no-cart.png" alt="" width="100%">
              <a class="btn btn-block btn-primary py-4 rounded-0 mb-4" ng-click="showLogin()">Đăng nhập</a>
            </div>
          </div>
        </div>
