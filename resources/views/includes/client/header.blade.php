    ...
    <div class="container-fluid px-2 px-md-5 px-xl-8d75">
      <div class="topbar__nav d-md-flex justify-content-between align-items-center">
        <ul class="topbar__nav--left nav ml-md-n3">
          <li class="nav-item"><a href="#" class="nav-link link-black-100"><i class="glph-icon flaticon-question mr-2"></i>Bạn cần hỗ trợ?</a></li>
          <li class="nav-item"><a href="tel:+1246-345-0695" class="nav-link link-black-100"><i class="glph-icon flaticon-phone mr-2"></i>+84 983-932-832</a></li>
        </ul>
      ...
      <div class="d-flex align-items-center position-relative flex-wrap">
        ...
        <div class="site-navigation mr-auto d-none d-xl-block">
          <ul class="nav">
            ...
            <li class="nav-item"><a href="#" class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium active border-bottom border-primary border-width-2">Loại sách</a></li>
            <li class="nav-item dropdown">
        ...
        <div class="site-search ml-xl-0 ml-md-auto w-r-100 my-2 my-xl-0">
          <form class="form-inline">
            <div class="input-group">
              ...
              <input class="form-control bg-white-100 min-width-380 py-2d75 height-4 border-white-100" type="search" placeholder="Nhập tên sách bạn muốn tìm ..." aria-label="Search">
            </div>
