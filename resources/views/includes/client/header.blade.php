    ...
    <div class="container-fluid px-2 px-md-5 px-xl-8d75">
      <div class="topbar__nav d-md-flex justify-content-between align-items-center">
        <ul class="topbar__nav--left nav ml-md-n3">
          <li class="nav-item"><a href="#" class="nav-link py-0 link-black-100"><i class="glph-icon flaticon-question mr-2"></i>Bạn cần hỗ trợ?</a></li>
          <li class="nav-item"><a href="tel:+1246-345-0695" class="nav-link py-0 link-black-100"><i class="glph-icon flaticon-phone mr-2"></i>+84 983-932-832</a></li>
        </ul>
        <ul class="topbar__nav--right nav mr-md-n3">
          <li class="nav-item"><a href="#" class="nav-link py-0 link-black-100 "><i class="fab fa-facebook-f"></i></a></li>
          <li class="nav-item"><a href="#" class="nav-link py-0 link-black-100 "><i class="fab fa-twitter"></i></a></li>
          <li class="nav-item"><a href="#" class="nav-link py-0 link-black-100 "><i class="fab fa-instagram"></i></a></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="container py-2 py-md-4">
        <div class="d-flex align-items-center position-relative flex-wrap">
            ...
            <div class="site-search ml-xl-0 ml-md-auto w-r-100 my-2 my-xl-0">
              <form class="form-inline">
                <div class="input-group">
                  ...
                  <input class="form-control bg-white-100 min-width-380 py-2d75 height-4 border-white-100" type="search" placeholder="Search for Books by Keyword ..." aria-label="Search" spellcheck="false" data-ms-editor="true" ng-model="keyword">
          ...
          <div class="d-flex align-items-center ml-auto justify-content-end" style="flex: 1;">
            ...
            <a href="/shop/my-account" class="target-of-invoker-has-unfolds" ng-if="customer.id">
              <div class="d-flex align-items-center text-dark font-size-2 text-lh-sm">
                <i class="flaticon-user font-size-5"></i>
                <div class="ml-2 d-none d-md-block">
                  <div class="h6 mb-0 h-primary">@{{customer.info ? customer.info.full_name : customer.username}}</div>
                </div>
              </div>
            </a>
            ...
            <a id="sidebarNavToggler1" href="javascript:;" role="button" class="d-none d-md-block ml-4 target-of-invoker-has-unfolds" aria-controls="sidebarContent1" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-hide-on-scroll="false" data-unfold-target="#sidebarContent1" data-unfold-type="css-animation" data-unfold-overlay="{
              ...
              <div class="d-flex align-items-center text-dark font-size-2 text-lh-sm position-relative">
                <span class="position-absolute bg-dark width-16 height-16 rounded-circle d-flex align-items-center justify-content-center text-white font-size-n9 left-0 top-0 ml-n2 mt-n1">@{{$root.customer.cart_details.length || 0}}</span>
                <i class="flaticon-icon-126515 font-size-5"></i>
                <div class="ml-2 d-none d-md-block">
                  <span class="text-secondary-gray-1090 font-size-1">Giỏ</span>
                  <div class="h8 mb-0 text-primary">@{{$root.total | number}}</div>
                </div>
              </div>
            </a>
