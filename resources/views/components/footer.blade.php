      ...
      <div class="container">
        ...
        <div class="space-bottom-2 space-bottom-md-3">
          <div class="text-center mb-5">
            <h5 class="font-size-7 font-weight-medium">Nhận Tin Tức Từ Chúng Tôi</h5>
            <p class="text-gray-700">Đăng ký để là người đầu tiên nghe về các sản phẩm độc quyền, ưu đãi đặc biệt và các bộ sưu tập sắp ra mắt</p>
          </div>
            ...
            <div class="col-md-5 mb-3 mb-md-2">
              <div class="js-form-message">
                <div class="input-group">
                  <input type="text" class="form-control px-5 height-60 border-dark" name="name" id="signupSrName" placeholder="Nhập email của bạn" aria-label="Your name" required="" data-msg="Name must contain only letters." data-error-class="u-has-error" data-success-class="u-has-success">
                </div>
              </div>
            </div>
            <div class="col-sm-2 ml-md-2">
              <button type="submit" class="btn btn-dark rounded-0 btn-wide py-3 font-weight-medium">Đăng ký
              </button>
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="pb-6">
              ...
              <address class="font-size-2 mb-5">
                <span class="mb-2 font-weight-normal text-dark">
                  Trường đại học sư phạm kỹ thuật Hưng Yên, cơ sở 2 <br> Mỹ Hào
                </span>
              </address>
              <div class="mb-4">
                <a href="mailto:minhbaly@hotro.com" class="font-size-2 d-block link-black-100 mb-1">minhbaly@hotro.com</a>
                <a href="tel:+1246-345-0695" class="font-size-2 d-block link-black-100">+84 983-932-832</a>
              </div>
          ...
          <div class="col-lg-2 mb-6 mb-lg-0">
            <h4 class="font-size-3 font-weight-medium mb-2 mb-xl-5 pb-xl-1">Khám phá</h4>
            <ul class="list-unstyled mb-0">
              <li class="pb-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Về chúng tôi</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Sơ đồ trang web</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Bookmarks</a>
              </li>
              <li class="pt-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Đăng nhập</a>
              </li>
            </ul>
          </div>
          <div class="col-lg-2 mb-6 mb-lg-0">
            <h4 class="font-size-3 font-weight-medium mb-2 mb-xl-5 pb-xl-1">Dịch vụ</h4>
            <ul class="list-unstyled mb-0">
              <li class="pb-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Trung tâm hỗ trợ</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Đổi trả</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Thu hồi sản phẩm</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Quyền</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Liên hệ chúng tôi</a>
              </li>
            </ul>
          </div>
          <div class="col-lg-2 mb-6 mb-lg-0">
            <h4 class="font-size-3 font-weight-medium mb-2 mb-xl-5 pb-xl-1">Chính sách</h4>
            <ul class="list-unstyled mb-0">
              <li class="pb-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Chính sách hoàn trả</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Điều khoản sử dụng</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Bảo vệ</a>
              </li>
              <li class="pt-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Riêng tư</a>
              </li>
            </ul>
          </div>
          <div class="col-lg-2 mb-6 mb-lg-0">
            <h4 class="font-size-3 font-weight-medium mb-2 mb-xl-5 pb-xl-1">Loại sách</h4>
            <ul class="list-unstyled mb-0">
              <li class="pb-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Hành động</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Hài hước</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Kịch tính</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Kinh dị</a>
              </li>
              <li class="py-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Cho trẻ em</a>
              </li>
              <li class="pt-2">
                <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="#">Hài lãng mạn</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="space-1">
      <div class="container">
        <div class="d-lg-flex text-center text-lg-left justify-content-between align-items-center">
          ...
          <p class="mb-3 mb-lg-0 font-size-2">©2022 Book Worm. Đã đăng ký bản quyền</p>
          ...
          <div class="ml-auto d-lg-flex align-items-center">
            ...
            <select class="js-select selectpicker dropdown-select mb-3 mb-lg-0" data-style="border px-4 py-2 rounded-0 height-5 outline-none shadow-none form-control font-size-2" data-dropdown-align-right="true">
              <option value="one" selected>Tiếng Việt</option>
              <option value="two">English (United States)</option>
            </select>
            ...
            <select class="js-select selectpicker dropdown-select ml-md-3" data-style="border px-4 py-2 rounded-0 height-5 outline-none shadow-none form-control font-size-2" data-dropdown-align-right="true" data-width="fit">
              <option value="one" selected>đ VND</option>
              <option value="two">$ USD</option>
            </select>
          </div>
        </div>
      </div>
