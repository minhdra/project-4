...
<main id="content">
  <div class="py-3 py-lg-7">
    <h6 class="font-weight-medium font-size-7 text-center my-1">Liên lạc với chúng tôi</h6>
  </div>
          ...
          <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-3">
            <div class="ml-xl-4">
              <div class="mb-4 mb-lg-7">
                <h6 class="font-weight medium font-size-10 mb-4 mb-lg-7">Thông tin liên lạc</h6>
                <p class="font-weight-medium font-italic">Chúng tôi sẽ trả lời bất kỳ câu hỏi nào bạn có thể có về cửa hàng của chúng tôi.
                </p>
              </div>
              <div class="mb-4 mb-lg-8">
                <div class="row">
                  <div class="col-md-6">
                    <h6 class="font-weight-medium font-size-4 mb-4">Trường đại học sư phạm kỹ thuật Hưng Yên</h6>
                    <address class="font-size-2 mb-5">
                      <span class="mb-2 font-weight-normal text-dark">
                        Bần Yên Nhân, Hưng Yên <br> Việt Nam
                      </span>
                    </address>
                    <div>
                      <a href="mailto:minhbaly2022@gmail.com" class="font-size-2 d-block link-black-100 mb-1">minhbaly2022@gmail.com</a>
                      <a href="tel:+1246-345-0695" class="font-size-2 d-block link-black-100">+84 983-932-832</a>
                    </div>
                  </div>
                  <!-- <div class="col-md-6">
                    <h6 class="font-weight-medium font-size-4 mb-4">Cửa hàng Bần Yên Nhân</h6>
                    <address class="font-size-2 mb-5">
                      <span class="mb-2 font-weight-normal text-dark">
              ...
              <div class="mb-5 mb-xl-9 pb-xl-1">
                <h6 class="font-size-4 font-weight-medium">Mạng xã hội</h6>
