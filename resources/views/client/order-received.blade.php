    ...
    <div class="container">
      ...
      <div class="max-width-890 mx-auto">
        <div class="bg-white pt-6 border">
          <h6 class="font-size-3 font-weight-medium text-center mb-4 pb-xl-1">Cảm ơn bạn. Đơn hàng của bạn đã được xác nhận</h6>
              ...
              <table class="table table-borderless mb-0 ml-1">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="pr-0 py-0 font-weight-medium">Tháng Ba 24, 2020</td>
                    <td class="pr-0 py-0 font-weight-medium text-md-center">đ125.000</td>
                    <td class="pr-md-4 py-0 font-weight-medium text-md-right">Chuyển khoản</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div class="px-3 px-md-4">
              <div class="ml-md-2">
                ...
                <div class="d-flex justify-content-between mb-4">
                  ...
                  <span class="font-weight-medium font-size-2">đ500.000</span>
                </div>
                <div class="d-flex justify-content-between">
                  ...
                  <span class="font-weight-medium font-size-2">đ325.000</span>
                </div>
              </div>
            </div>
          </div>
          <div class="border-bottom mb-5 pb-5">
            <ul class="list-unstyled px-3 pl-md-5 pr-md-4 mb-0">
              <li class="d-flex justify-content-between py-2">
                ...
                <span class="font-weight-medium font-size-2">đ1.000.000</span>
              </li>
              <li class="d-flex justify-content-between py-2">
              ...
              <li class="d-flex justify-content-between pt-2">
                ...
                <span class="font-weight-medium font-size-2">Chuyển khoản</span>
              </li>
            </ul>
          </div>
