    ...
    <div class="main-content">
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <h2 class="content-header">Quản lý tác giả</h2>
            ...
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  ...
                  <input type="text" class="form-control" id="author-name" ng-model="item.author_name" require>
                </fieldset>
              </div>
            </div>
          </div>
...
@section('js')
<script src="/assets/js/controllers/authorsController.js"></script>
<script>
