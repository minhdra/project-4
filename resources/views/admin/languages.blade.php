...
@section('content')
<div ng-controller="book_languagesController">
    ...
    <div class="main-content">
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <h2 class="content-header">Quản lý ngôn ngữ</h2>
            ...
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  <label for="language-name">Tên ngôn ngữ</label>
                  <input type="text" class="form-control" id="language-name" ng-model="item.language_name" require>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  <label for="language-code">Viết tắt</label>
                  <input type="text" class="form-control" id="language-code" ng-model="item.language_code" require>
                </fieldset>
              </div>
            </div>
          </div>
...
@section('js')
<script src="/assets/js/controllers/book_languagesController.js"></script>
<script>
