    ...
    <div class="main-content">
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <h2 class="content-header">Quản lý loại sách</h2>
            ...
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  <label for="category-name">Tên loại sách</label>
                  <input type="text" class="form-control" id="category-name" ng-model="item.category_name" require>
                </fieldset>
              </div>
            </div>
          </div>
