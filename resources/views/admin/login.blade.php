        ...
        <div class="row full-height-vh">
          <div class="col-12 d-flex align-items-center justify-content-center gradient-aqua-marine">
            <div class="card px-4 py-2 box-shadow-2 width-400">
              ...
              <div class="site-branding mx-auto mx-md-0 d-flex  justify-content-center" style="flex: 1; align-self: center;margin-bottom:10px;">
            <a href="http://127.0.0.1:8000/shop" class="d-block mb-1">
